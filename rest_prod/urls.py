...
from rest_prod.views import lista_productos,lista_prod, detalle_prod,eliminar_prod,lista_carro,lista_carro_prod_add,lista_carro_prod_del,lista_carro_prod_reduce
